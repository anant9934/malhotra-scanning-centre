...
export function CTASection({ phoneVal, phoneClean }: CTASectionProps) {
  return (
      ...
      <div className="container">
        <div className={styles.ctaBox}>
          ...
          <div className={styles.ctaMiddle}>
            <Button href="/appointment" variant="secondary" size="lg" fullWidth>
              <Clock size={16} style={{marginRight: '0.5rem'}}/> Book Appointment <ArrowRight size={16} style={{marginLeft: '0.5rem'}}/>
            </Button>
            <Button href={`tel:+91${phoneClean}`} variant="outline" size="lg" fullWidth style={{borderColor: 'rgba(255,255,255,0.3)', color: 'white'}}>
              <Phone size={16} style={{marginRight: '0.5rem'}}/> Call {phoneVal}
            </Button>
          </div>
