      ...
      <section className="section-padding">
        <div className="container">
          <div style={{ maxWidth: '800px', margin: '0 auto' }}>
            <span className="eyebrow">{dictionary.nav.about.toUpperCase()}</span>
            ...
            <div style={{ marginTop: '4rem', display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
              <Button href={`/${locale}/centres`} variant="primary">{dictionary.nav.centres}</Button>
              <Button href={`/${locale}/radiologist`} variant="outline">{dictionary.nav.radiologist}</Button>
            </div>
          </div>
        </div>
      </section>
